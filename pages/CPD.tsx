...
const CPD: React.FC = () => {
  ...
  const services: ServiceSection[] = [
    { 
      id: 'portal',
      title: 'Digital Makerspace Portal', 
      ...
      isCore: true,
      details: {
        whatIs: "The infrastructure of the ThynkLab Method. The Portal is a platform-as-a-service that provides the roadmap, resources, and evidence-capture tools for every student.",
    ...
    { 
      id: 'online',
      title: 'Online CPD', 
      desc: 'Self-paced modules delivered through the portal, focusing on method mastery and technical skills.',
      details: {
        whatIs: "The foundation of ThynkLab’s professional learning. Self-paced modules delivered through the ThynkLab Portal, designed to fit real school timetables.",
        learnHeading: "What teachers learn",
        learnItems: [
          "The ThynkLab Method® in depth",
          "How to remove the blank canvas in STEAM lessons",
          "How to run effective design cycles",
    ...
    { 
      ...
      details: {
        whatIs: "Virtual or Hands-on workshops for whole-school teams who want to explore the ThynkLab Method® together and build shared understanding, regardless of location.",
        ...
        whyWorks: [
          ...
          "Reinforces what’s learned online"
        ],
        bestFor: [
    ...
    { 
      ...
      desc: 'Ongoing guidance and exemplar materials to ensure every lesson is delivered with confidence.',
      details: {
